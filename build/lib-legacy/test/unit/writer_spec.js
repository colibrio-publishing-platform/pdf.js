...
describe("Writer", function () {
  ...
  describe("XFA", function () {
    it("should update AcroForm when no datasets in XFA array", function () {
      var originalData = new Uint8Array();
      var newRefs = [];
      var acroForm = new _primitives.Dict(null);
      acroForm.set("XFA", ["preamble", _primitives.Ref.get(123, 0), "postamble", _primitives.Ref.get(456, 0)]);

      var acroFormRef = _primitives.Ref.get(789, 0);

      var xfaDatasetsRef = _primitives.Ref.get(101112, 0);

      var xfaData = "<hello>world</hello>";
      var xrefInfo = {
